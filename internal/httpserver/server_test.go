...
import (
	...
	"github.com/anupam2105/pageguard/internal/httpserver"
	"github.com/anupam2105/pageguard/internal/observability"
)
...
// doGet issues a GET and returns (status, body). Body is fully read and
// closed inside the helper so linters see close discipline at the call site.
...
func TestMetricsEndpointExposesExpectedSeries(t *testing.T) {
	...
	want := []string{
		"go_goroutines",
		"pageguard_http_requests_total",
		"pageguard_http_request_duration_seconds",
	}
